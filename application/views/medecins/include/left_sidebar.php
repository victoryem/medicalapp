            ...
            <div class="navbar-vertical-content scrollbar">
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                ...
                <li class="nav-item">
                  ...
                  <!-- parent pages--><a class="nav-link" href="<?php echo base_url(); ?>medecins/dashboard/demandes" role="button" data-bs-toggle="" aria-expanded="false">
                ...
                <li class="nav-item">
                  ...
                  <!-- parent pages--><a class="nav-link" href="<?php echo base_url(); ?>medecins/dashboard/patients" role="button" data-bs-toggle="" aria-expanded="false">
                ...
                <li class="nav-item">
                  <!-- label-->
                  <div class="row navbar-vertical-label-wrapper mt-3 mb-2">
                    <div class="col-auto navbar-vertical-label">Disponibilités
                    </div>
                    <div class="col ps-0">
                      <hr class="mb-0 navbar-vertical-divider" />
                    </div>
