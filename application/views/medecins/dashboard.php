                    ...
                    <div class="col-lg-4 col-xl-12">
                      <div class="card h-100">
                        <div class="card-header d-flex flex-between-center pb-0">
                          <h2 class="mb-0">Vos rendez-vous de la journée</h2>
                        </div>
                          ...
                          <table class="table fs--1 mb-0 overflow-hidden">
                            ...
                            <?php foreach ($demandes as $demande): ?>
                              <tr class="btn-reveal-trigger">
                                ...
                                <td class="align-middle white-space-nowrap  email"><?php echo $demande->date  ?> <?php echo $demande->heure  ?></td>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document" style="max-width: 500px">
    <div class="modal-content position-relative">
      ...
      <div class="modal-body p-0">
        ...
        <div class="p-4 pb-0">
            <form action ="<?php echo base_url(); ?>secretaires/dashboard/cancelAfter" method="post">
            <div class="mb-3">
              <label class="col-form-label" for="message-text">Raison de l'annulation:</label>
              <textarea class="form-control" id="message-text" name ="raison"></textarea>
            </div>
            <input type="hidden" name="id" value="<?php echo $demande->id ?>">
            <button class="btn btn-danger" type="submit" data-bs-dismiss="modal">Oui, Annuler cette demande</button>
          </form>
      ...
      <button class="btn btn-secondary" type="button" data-bs-dismiss="modal">Non, Fermer</button>
                    ...
                    <?php else: ?>
                      <div class="text-center ">
                          <p class="fw-bold fs-1 mt-3">Aucun rendez-vous pour aujourd'hui.</p>
                        </div>
                        </div>
                        </div>
                    <?php endif; ?>
