                    ...
                    <div class="col-lg-4 col-xl-12">
                      <div class="card h-100">
                        <div class="card-header d-flex flex-between-center pb-0">
                          <h2 class="mb-0">Overview-Utilisateur</h2>
                        </div>
                            ...
                            <div class="col">
                              <div class="d-flex align-items-center"><img class="me-3" src="assets/img/icons/weather-icon.png" alt="" height="60" />
                                <div>
                                  ...
                                  <button class="btn btn-outline-primary rounded-pill me-1 mb-1" type="button"><a href="<?php echo base_url(); ?>admin/dashboard/add">Ajouter un utilisateur</a></button>
                                  </div>
                                </div>
                              </div>
                            </div>
                      ...
                      <div class="card-header">
                        <div class="row flex-between-center">
                          <div class="col-auto col-sm-6 col-lg-7">
                            <h6 class="mb-0 text-nowrap py-2 py-xl-0">Les utilisateurs</h6>
                          </div>
                            ...
                            <?php foreach ($users as $user): ?>
                              <tr class="btn-reveal-trigger">
                                <td class="align-middle white-space-nowrap nom">
                                  <a class="text-primary fw-semi-bold" href="#!"><?php echo $user->nom ?> <?php echo $user->prenom ?></a>
                                ...
                                <td class="align-middle white-space-nowrap  email"><?php echo $user->email ?></td>
                                <?php if($user->role == 'admin'): ?>
                                    <td class="align-middle white-space-nowrap role ">Administrateur</td>
                                <?php endif; ?>
                                <?php if($user->role == 'medecin'): ?>
                                    <td class="align-middle white-space-nowrap role ">Médecin</td>
                                <?php endif; ?>
                                <?php if($user->role == 'secretaire'): ?>
                                    <td class="align-middle white-space-nowrap role ">Sécretaire</td>
                                <?php endif; ?>
                                
                                <td class="text-end">
                                    <div>
                                        <button class="btn p-0" data-bs-toggle="modal" data-bs-target="#error-modal" type="button" data-bs-toggle="tooltip" data-bs-placement="top" title="Modifier"><span class="text-500 fas fa-edit"></span></button>
                                        <button class="btn p-0 ms-2" type="button"  data-bs-placement="top" title="Voir"><a href="<?php echo base_url(); ?>admin/dashboard/view/<?php echo $user->id ?>"><span class="text-500 fas fa-eye"></span></a></button>
                                      </div>
                                </td>
                              </tr>
                              <?php endforeach ?>
