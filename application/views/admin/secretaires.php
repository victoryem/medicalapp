                    ...
                    <div class="col-lg-4 col-xl-12">
                      <div class="card h-100">
                        <div class="card-header d-flex flex-between-center pb-0">
                          <h2 class="mb-0">Overview-Secrétaires</h2>
                        </div>
                            ...
                            <div class="col">
                              <div class="d-flex align-items-center"><img class="me-3" src="assets/img/icons/weather-icon.png" alt="" height="60" />
                                <div>
                                  ...
                                  <button class="btn btn-outline-primary rounded-pill me-1 mb-1" type="button"><a href="<?php echo base_url(); ?>admin/dashboard/add">Ajouter un secrétaire</a></button>
                                  </div>
                                </div>
                              </div>
                            </div>
                      ...
                      <div class="card-header">
                        <div class="row flex-between-center">
                          <div class="col-auto col-sm-6 col-lg-7">
                            <h6 class="mb-0 text-nowrap py-2 py-xl-0">Les Sécretaires</h6>
                          </div>
         ...
         <?php endif; ?>
                    ...
                    <?php else: ?>
                      <div class="text-center ">
                          <p class="fw-bold fs-1 mt-3">Aucun secretaire trouvé.</p>
                        </div>
                        </div>
                        </div>
                    <?php endif; ?>
