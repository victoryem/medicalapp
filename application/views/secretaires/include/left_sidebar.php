          ...
          <div class="collapse navbar-collapse" id="navbarVerticalCollapse">
            <div class="navbar-vertical-content scrollbar">
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                <li class="nav-item">
                  <!-- parent pages--><a class="nav-link" href="<?php echo base_url(); ?>secretaires/" role="button" data-bs-toggle="collapse" aria-expanded="false" aria-controls="dashboard">
                ...
                <li class="nav-item">
                  ...
                  <div class="row navbar-vertical-label-wrapper mt-3 mb-2">
                    <div class="col-auto navbar-vertical-label">Consutations
                    </div>
                    <div class="col ps-0">
                      <hr class="mb-0 navbar-vertical-divider" />
                    </div>
                  </div>
                  <!-- parent pages--><a class="nav-link" href="<?php echo base_url(); ?>secretaires/dashboard/demandes" role="button" data-bs-toggle="" aria-expanded="false">
                  ...
                  <!-- parent pages--><a class="nav-link" href="<?php echo base_url(); ?>secretaires/dashboard/avenir" role="button" data-bs-toggle="" aria-expanded="false">
                  ...
                  <!-- parent pages--><a class="nav-link" href="<?php echo base_url(); ?>secretaires/dashboard/end" role="button" data-bs-toggle="" aria-expanded="false">
                  ...
                  <!-- parent pages--><a class="nav-link" href="<?php echo base_url(); ?>secretaires/dashboard/add" role="button" data-bs-toggle="" aria-expanded="false">
                ...
                <li class="nav-item">
                  <!-- label-->
                  <div class="row navbar-vertical-label-wrapper mt-3 mb-2">
                    <div class="col-auto navbar-vertical-label">Patients
                    </div>
                    <div class="col ps-0">
                      <hr class="mb-0 navbar-vertical-divider" />
                    </div>
                  </div>
                  <!-- parent pages--><a class="nav-link" href="<?php echo base_url(); ?>secretaires/dashboard/patients" role="button" data-bs-toggle="" aria-expanded="false">
                    <div class="d-flex align-items-center"><span class="nav-link-icon"><span class="fas fa-flag"></span></span><span class="nav-link-text ps-1">Voir les patients</span>
                    </div>
                  </a>
                </li>
                ...
                <li class="nav-item">
                  <!-- label-->
                  <div class="row navbar-vertical-label-wrapper mt-3 mb-2">
                    <div class="col-auto navbar-vertical-label">Pharmacie
                    </div>
                    <div class="col ps-0">
                      <hr class="mb-0 navbar-vertical-divider" />
                    </div>
                  </div>
                  <!-- parent pages--><a class="nav-link" href="<?php echo base_url(); ?>secretaires/dashboard/pharma" role="button" data-bs-toggle="" aria-expanded="false" aria-controls="forms">
